# session-extensions-panel Specification

## Purpose

Define how the session-side extensions panel groups connectors and skills, exposes their management flows, and keeps the standalone settings experience unchanged.
