...
Keep Chat and Contacts navigation aligned with the active organization's authenticated IM availability, without exposing navigation from stale credentials.
