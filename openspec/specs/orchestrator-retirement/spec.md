# orchestrator-retirement Specification

## Purpose
Define safe migration away from the orchestrator package, compatibility behavior, legacy state handling, and removal of obsolete distribution artifacts.
