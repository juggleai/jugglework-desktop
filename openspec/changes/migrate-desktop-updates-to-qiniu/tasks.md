...
- [ ] 29.3 Build from the exact committed source; sign, notarize, staple, Gatekeeper-verify, and fully validate ARM64 ZIP and DMG plus blockmaps and updater manifest
- [ ] 29.4 Upload and verify all five immutable Qiniu objects; write and verify the Stable object under the audited cache exception without forced CDN convergence
- [ ] 29.5 Update China and overseas Den serially; deploy the website Mac download link and the explicitly included ICP-filing changes
