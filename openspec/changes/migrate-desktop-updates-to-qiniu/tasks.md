...
## 16. Windows ARM64 1.2.17 immutable candidate (2026-09-14)
...
- The immutable version manifest is `jugglework/releases/v1.2.17/windows/latest.yml`: size `508`, SHA-256 `d8c14e52af5fa511aeaa2ab14d9275ef12a58b446f2b429d4bf15ac8119fd1d4`, and Qiniu ETag `FhyCpJvQ8B8nsPp3zgO1AdAC3Mo4`. It uses an absolute immutable CDN URL for the ARM64 installer.
...
- [ ] 17.8 Implement and verify channel-object cache metadata mutation under the promotion lock before CDN refresh; the current promotion code does not set revalidation metadata
