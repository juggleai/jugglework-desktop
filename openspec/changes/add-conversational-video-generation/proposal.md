...
- Extend per-model media configuration to text-to-image, image-to-image, and multi-image-to-image models.
...
- `image-model-generation`: Discover and invoke configured image models for text, single-image, and multi-image generation while publishing validated workspace image artifacts.
