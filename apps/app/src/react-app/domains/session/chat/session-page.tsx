...
export function SessionPage(props: SessionPageProps) {
  ...
  const focusWorkbenchSessionControlAction = useMemo<JuggleWorkControlAction>(() => ({
    ...
    args: [{
      ...
      type: "string",
      required: true,
      description: "Session id from the JuggleWork context resources or conversation tabs.",
    }],
    execute: (args) => {
    ...
    <div className="flex h-full min-h-0 flex-col bg-[radial-gradient(circle_at_top,rgba(74,111,255,0.12),transparent_42%),var(--app-bg,#0b1020)] text-dls-text mac:bg-transparent">
      ...
      >
        <AppSidebar
          ...
          visibleSessionIds={splitSessionId ? [props.sidebar.selectedSessionId, splitSessionId].filter(Boolean) as string[] : undefined}
