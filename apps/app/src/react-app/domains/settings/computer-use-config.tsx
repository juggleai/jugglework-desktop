...
function hasDesktopBridge() {
  return typeof window !== "undefined" && Boolean(window.__JUGGLEWORK_ELECTRON__?.invokeDesktop);
}
...
export function ComputerUseConfig({
  ...
  const {
    ...
    mutationFn: async () => {
      if (!hasDesktopBridge()) {
        throw new Error("Computer Use is Mac only and requires the JuggleWork desktop app on macOS.");
      }
