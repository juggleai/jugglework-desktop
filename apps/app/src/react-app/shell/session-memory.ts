...
const SESSION_BY_WORKSPACE_KEY = "jugglework.react.sessionByWorkspace";
const WORKSPACE_ORDER_KEY = "jugglework.react.workspaceOrder";
const WORKSPACE_PROJECT_DIMENSION_KEY = "jugglework.react.workspaceProjectDimension";
