...
import { usePublishJuggleWorkContext } from "./control/control-provider";
import { buildJuggleWorkContext } from "./jugglework-context-projector";
import { useUiStateStore } from "./ui-state-store";

export function JuggleWorkContextPublisher() {
  ...
  const context = useMemo(() => buildJuggleWorkContext({
    route,
    revision,
  ...
  usePublishJuggleWorkContext(context);
  return null;
}
