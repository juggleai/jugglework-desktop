...
export const openMarketplacePluginEvent = "jugglework-open-marketplace-plugin";

const PENDING_MARKETPLACE_PLUGIN_KEY = "jugglework:pending-marketplace-plugin";
...
const ALERT_TOAST_ID = "jugglework-notification-alert";
