...
export type JuggleWorkSessionCreateResult = {
  ok: boolean
...
export function parseJuggleWorkSessionCreateResult(output: unknown): JuggleWorkSessionCreateResult | null {
...
export function JuggleWorkSessionCreateTool({ part }: { part: DynamicToolUIPart }) {
  ...
  const result = parseJuggleWorkSessionCreateResult(part.output)
  if (!result) {
  ...
  return (
    <div
      ...
      data-jugglework-session-create-card
