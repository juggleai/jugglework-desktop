...
const ELECTRON_ALPHA_RELEASE_BASE_URL =
  "https://github.com/juggleai/jugglework-desktop/releases/download/alpha-macos-latest";

export const ELECTRON_ALPHA_RELEASE_PAGE_URL =
  "https://github.com/juggleai/jugglework-desktop/releases/tag/alpha-macos-latest";
