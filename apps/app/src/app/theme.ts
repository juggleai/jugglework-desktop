...
const THEME_PREF_KEY = "jugglework.react.settings.theme-mode";
const LEGACY_THEME_PREF_KEYS = ["jugglework.themePref"];
...
const syncNativeTheme = (mode: ThemeMode) => {
  ...
  void window.__JUGGLEWORK_ELECTRON__?.invokeDesktop?.("__setNativeTheme", mode);
};
