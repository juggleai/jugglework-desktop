...
export default {
  ...
  "session.share_openwork_workers_only": "分享服务链接仅适用于JuggleWork工作区。",
  ...
  "settings.debug_openwork_server_version": "JuggleWork服务器：{version}",
  ...
  "settings.environment.validation_reserved": "OPENWORK_ 和 OPENCODE_ 名称由 JuggleWork/OpenCode 管理。",
  ...
  "settings.openwork_diagnostics_title": "JuggleWork服务器诊断",
  "settings.openwork_server_desc": "用于应用同步、工作者和远程连接的会话控制平面。",
  "settings.openwork_server_label": "JuggleWork服务器",
  ...
  "settings.reset_openwork_title": "重置JuggleWork + OpenCode状态",
  ...
  "status.openwork_ready": "JuggleWork就绪",
