...
export default {
  ...
  "den.error_paste_valid_code": "Paste a valid JuggleWork sign-in link or one-time sign-in code.",
  ...
  "den.signin_code_note": "Accepts an jugglework://den-auth link or the raw one-time grant.",
  "den.signin_link_copied": "Copied",
  "den.signin_link_hint": "If your browser doesn't bounce back into JuggleWork automatically, paste the sign-in link or one-time code from JuggleWork Cloud here.",
  "den.signin_link_label": "Sign-in link or one-time code",
  "den.signin_link_placeholder": "jugglework://den-auth?... or pasted code",
