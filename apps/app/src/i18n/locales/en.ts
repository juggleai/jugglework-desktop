...
export default {
  ...
  "composer.runtime_label": "Agent runtime",
  "composer.runtime_opencode": "OpenCode",
  "composer.runtime_codex": "Codex",
  "composer.runtime_codex_local_only": "Codex is currently available for local workspaces only",
  "composer.runtime_new_session": "Created a session with the selected agent",
  "composer.agent_profile_label": "OpenCode agent",
  ...
  "runtime.codex_unavailable": "Codex requires a signed-in local workspace and an available model.",
  "runtime.codex_start_failed": "Could not start the Codex session",
