...
export default {
  ...
  "composer.connect_mcp_prompt": "Use the \"{name}\" organization MCP through JuggleWork Cloud. Call jugglework-cloud_search_capabilities with query \"{name}\" (that tool accepts only query and limit), then call jugglework-cloud_execute_capability with an exact returned name. If no match is returned, report that the Cloud capability catalog has not exposed this connection yet; do not claim it is a local MCP. Use it to ",
  "composer.connect_mcp_prompt_resolved": "Use the \"{name}\" organization MCP through JuggleWork Cloud. This connection is confirmed reachable and exposes: {capabilities}. Call jugglework-cloud_execute_capability directly with an exact name from that list; only call jugglework-cloud_search_capabilities again if you need a capability outside it. Do not look for it as a local MCP server. Use it to ",
  ...
  "composer.local_mcp_prompt": "Use the \"{name}\" MCP server to ",
  ...
  "composer.mcp_needs_auth": "\"{name}\" is not connected yet. Connect it before using it in a task.",
  "composer.mcp_unavailable": "\"{name}\" is unavailable ({status}).",
  "composer.mcp_not_in_cloud_catalog": "\"{name}\" is connected, but your organization has not shared it with any member or team, so it is not in the Cloud capability catalog. Grant access to this connection in the JuggleWork console.",
