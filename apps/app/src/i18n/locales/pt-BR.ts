...
export default {
  ...
  "session.share_openwork_workers_only": "Links de compartilhamento estão disponíveis para workers JuggleWork.",
  ...
  "settings.openwork_diagnostics_title": "Diagnósticos do servidor JuggleWork",
  ...
  "settings.reset_openwork_title": "Redefinir estado do JuggleWork + OpenCode",
  ...
  "status.openwork_ready": "JuggleWork Pronto",
