...
import { JuggleWorkSessionCreateTool } from "../src/components/tools/jugglework-session-create";
...
function sessionCreatePart(): DynamicToolUIPart {
  return {
    type: "dynamic-tool",
    toolName: "jugglework_session_create",
...
describe("JuggleWorkSessionCreateTool", () => {
    ...
    const html = renderToStaticMarkup(
      <MemoryRouter>
        <MessageListProvider
          ...
          onMcpRetry={noop}
        >
          <JuggleWorkSessionCreateTool part={sessionCreatePart()} />
        </MessageListProvider>
      </MemoryRouter>,
    );

    expect(html).toContain("data-jugglework-session-create-card");
