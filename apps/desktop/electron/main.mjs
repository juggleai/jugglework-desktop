...
// Keep this behavior aligned with the JuggleWork server so logo CDNs that
// expect a browser request behave the same at save time and apply time.
...
const DEFAULT_DEN_BASE_URL = "https://work.jugglechat.cn";
