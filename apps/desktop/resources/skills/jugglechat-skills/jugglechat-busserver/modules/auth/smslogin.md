---
name: jugglechat-busserver.auth.smslogin
module: auth
action: smslogin
title: 短验登录
http_method: POST
http_path: /jim/sms/login
path: /jim/sms/login
method: POST
source: login/smslogin.md
---
...

{
  ...
  "args": {
    ...
    "path": "/jim/sms/login",     // 后端 jim 接口路径
    "data": {"phone": "15212345678", "code": "000000"}
  },
  "meta": { /* 可选附加元数据 */ }
}
```
...
- im-docs 源文件：`busserver/login/smslogin.md`