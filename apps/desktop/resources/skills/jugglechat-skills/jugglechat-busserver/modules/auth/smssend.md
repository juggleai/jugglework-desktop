---
name: jugglechat-busserver.auth.smssend
module: auth
action: smssend
title: 短信验证码
http_method: POST
http_path: /jim/sms/send
path: /jim/sms/send
method: POST
source: login/smssend.md
---
...

{
  ...
  "args": {
    ...
    "path": "/jim/sms/send",     // 后端 jim 接口路径
    "data": {"phone": "15212345678"}
  },
  "meta": { /* 可选附加元数据 */ }
}
```
...
- im-docs 源文件：`busserver/login/smssend.md`