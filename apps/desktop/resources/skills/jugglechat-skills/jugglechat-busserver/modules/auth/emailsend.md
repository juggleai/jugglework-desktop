---
name: jugglechat-busserver.auth.emailsend
module: auth
action: emailsend
title: 邮箱验证码
http_method: POST
http_path: /jim/email/send
path: /jim/email/send
method: POST
source: login/emailsend.md
---
...

{
  ...
  "args": {
    ...
    "path": "/jim/email/send",     // 后端 jim 接口路径
    "data": {"email": "xxxxx@abc.com"}
  },
  "meta": { /* 可选附加元数据 */ }
}
```
...
- im-docs 源文件：`busserver/login/emailsend.md`