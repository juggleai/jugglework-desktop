---
name: jugglechat-busserver.auth.register
module: auth
action: register
title: 账号注册
http_method: POST
http_path: /jim/register
path: /jim/register
method: POST
source: login/register.md
---
...
- im-docs 源文件：`busserver/login/register.md`