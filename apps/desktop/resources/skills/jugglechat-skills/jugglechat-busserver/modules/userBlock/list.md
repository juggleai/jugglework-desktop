---
name: jugglechat-busserver.userBlock.list
module: userBlock
action: list
title: 查询黑名单用户列表
http_method: GET
http_path: /jim/users/blockusers/list
path: /jim/users/blockusers/list
method: GET
source: users/blockusers/qryblockusers.md
---
...
| --- | --- |
| HTTP 方法 | `GET` |
| 接口路径 | `/jim/users/blockusers/list` |
...

{
  ...
  "args": {
    ...
    "path": "/jim/users/blockusers/list",     // 后端 jim 接口路径
    "query": {"count": "20", "offset": "xxx"}
  },
  "meta": { /* 可选附加元数据 */ }
}
```
...
- im-docs 源文件：`busserver/users/blockusers/qryblockusers.md`