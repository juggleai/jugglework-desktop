---
name: jugglechat-busserver.userBlock.del
module: userBlock
action: del
title: 移除用户黑名单
http_method: POST
http_path: /jim/users/blockusers/del
path: /jim/users/blockusers/del
method: POST
source: users/blockusers/delblockusers.md
---
...

{
  ...
  "args": {
    ...
    "path": "/jim/users/blockusers/del",     // 后端 jim 接口路径
    "data": {"block_user_ids": ["userid1", "userid2"]}
  },
  "meta": { /* 可选附加元数据 */ }
}
```
...
- im-docs 源文件：`busserver/users/blockusers/delblockusers.md`