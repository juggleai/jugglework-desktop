---
name: jugglechat-busserver.userBlock.add
module: userBlock
action: add
title: 添加用户黑名单
http_method: POST
http_path: /jim/users/blockusers/add
path: /jim/users/blockusers/add
method: POST
source: users/blockusers/addblockusers.md
---
...

{
  ...
  "args": {
    ...
    "path": "/jim/users/blockusers/add",     // 后端 jim 接口路径
...
- im-docs 源文件：`busserver/users/blockusers/addblockusers.md`