---
name: jugglechat-busserver.groupMember.invite
module: groupMember
action: invite
title: 邀请入群
http_method: POST
http_path: /jim/groups/invite
path: /jim/groups/invite
method: POST
source: groups/membermanage/invitemember.md
---
...

{
  ...
  "args": {
    ...
    "path": "/jim/groups/invite",     // 后端 jim 接口路径
...
- im-docs 源文件：`busserver/groups/membermanage/invitemember.md`