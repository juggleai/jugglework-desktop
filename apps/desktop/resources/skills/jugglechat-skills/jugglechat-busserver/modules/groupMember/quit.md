---
name: jugglechat-busserver.groupMember.quit
module: groupMember
action: quit
title: 退出群组
http_method: POST
http_path: /jim/groups/quit
path: /jim/groups/quit
method: POST
source: groups/membermanage/quitgroup.md
---
...

{
  ...
  "args": {
    ...
    "path": "/jim/groups/quit",     // 后端 jim 接口路径
...
- im-docs 源文件：`busserver/groups/membermanage/quitgroup.md`