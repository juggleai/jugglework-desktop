---
name: jugglechat-busserver.groupMember.list
module: groupMember
action: list
title: 查询群成员列表
http_method: GET
http_path: /jim/groups/members/list
path: /jim/groups/members/list
method: GET
source: groups/membermanage/qrygroupmembers.md
---
...

{
  ...
  "args": {
    ...
    "path": "/jim/groups/members/list",     // 后端 jim 接口路径
    "query": {"group_id": "groupid1", "limit": "20", "offset": "xxx"}
  },
  "meta": { /* 可选附加元数据 */ }
}
```
...
- im-docs 源文件：`busserver/groups/membermanage/qrygroupmembers.md`