---
name: jugglechat-busserver.groupMember.del
module: groupMember
action: del
title: 移除群成员
http_method: POST
http_path: /jim/groups/members/del
path: /jim/groups/members/del
method: POST
source: groups/membermanage/delmember.md
---
...

{
  ...
  "args": {
    ...
    "path": "/jim/groups/members/del",     // 后端 jim 接口路径
...
- im-docs 源文件：`busserver/groups/membermanage/delmember.md`