---
name: jugglechat-busserver.groupSetting.setdisplayname
module: groupSetting
action: setdisplayname
title: 设置群昵称
http_method: POST
http_path: /jim/groups/setdisplayname
path: /jim/groups/setdisplayname
method: POST
source: groups/groupsetting/setgrpdisplayname.md
---
...
| --- | --- |
| HTTP 方法 | `POST` |
| 接口路径 | `/jim/groups/setdisplayname` |
...

{
  ...
  "args": {
    ...
    "path": "/jim/groups/setdisplayname",     // 后端 jim 接口路径
    "data": {"group_id": "group1", "grp_display_name": "xxxxxxxx"}
  },
  "meta": { /* 可选附加元数据 */ }
}
```
...
- im-docs 源文件：`busserver/groups/groupsetting/setgrpdisplayname.md`