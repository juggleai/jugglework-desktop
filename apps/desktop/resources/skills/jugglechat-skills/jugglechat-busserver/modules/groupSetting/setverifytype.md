---
name: jugglechat-busserver.groupSetting.setverifytype
module: groupSetting
action: setverifytype
title: 设置入群验证类型
http_method: POST
http_path: /jim/groups/management/setgrpverifytype
path: /jim/groups/management/setgrpverifytype
method: POST
source: groups/groupsetting/setgrpverifytype.md
---
...
| --- | --- |
| HTTP 方法 | `POST` |
| 接口路径 | `/jim/groups/management/setgrpverifytype` |
...

{
  ...
  "args": {
    ...
    "path": "/jim/groups/management/setgrpverifytype",     // 后端 jim 接口路径
    "data": {"group_id": "groupid1", "verify_type": 1}
  },
  "meta": { /* 可选附加元数据 */ }
}
```
...
- im-docs 源文件：`busserver/groups/groupsetting/setgrpverifytype.md`