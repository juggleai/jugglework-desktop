---
name: jugglechat-busserver.groupSetting.setannouncement
module: groupSetting
action: setannouncement
title: 设置群公告
http_method: POST
http_path: /jim/groups/setgrpannouncement
path: /jim/groups/setgrpannouncement
method: POST
source: groups/groupsetting/setgrpannouncement.md
---
...
| --- | --- |
| HTTP 方法 | `POST` |
| 接口路径 | `/jim/groups/setgrpannouncement` |
...

{
  ...
  "args": {
    ...
    "path": "/jim/groups/setgrpannouncement",     // 后端 jim 接口路径
    "data": {"group_id": "group1", "content": "xxxxxxxx"}
  },
  "meta": { /* 可选附加元数据 */ }
}
```
...
- im-docs 源文件：`busserver/groups/groupsetting/setgrpannouncement.md`