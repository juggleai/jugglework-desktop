---
name: jugglechat-busserver.groupSetting.setmute
module: groupSetting
action: setmute
title: 设置群禁言
http_method: POST
http_path: /jim/groups/management/setmute
path: /jim/groups/management/setmute
method: POST
source: groups/groupsetting/grpmute.md
---
...
| --- | --- |
| HTTP 方法 | `POST` |
| 接口路径 | `/jim/groups/management/setmute` |
...

{
  ...
  "args": {
    ...
    "path": "/jim/groups/management/setmute",     // 后端 jim 接口路径
    "data": {"group_id": "groupid1", "is_mute": 1}
  },
  "meta": { /* 可选附加元数据 */ }
}
```
...
- im-docs 源文件：`busserver/groups/groupsetting/grpmute.md`