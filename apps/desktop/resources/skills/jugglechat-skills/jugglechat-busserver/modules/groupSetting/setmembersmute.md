---
name: jugglechat-busserver.groupSetting.setmembersmute
module: groupSetting
action: setmembersmute
title: 设置群成员禁言
http_method: POST
http_path: /jim/groups/management/setgrpmembersmute
path: /jim/groups/management/setgrpmembersmute
method: POST
source: groups/groupsetting/setgrpmembersmute.md
---
...
| --- | --- |
| HTTP 方法 | `POST` |
| 接口路径 | `/jim/groups/management/setgrpmembersmute` |
...

{
  ...
  "args": {
    ...
    "path": "/jim/groups/management/setgrpmembersmute",     // 后端 jim 接口路径
    "data": {"group_id": "groupid1", "member_ids": ["userid1", "userid2"], "is_mute": 1}
  },
  "meta": { /* 可选附加元数据 */ }
}
```
...
- im-docs 源文件：`busserver/groups/groupsetting/setgrpmembersmute.md`