---
name: jugglechat-busserver.groupSetting.chgowner
module: groupSetting
action: chgowner
title: 变更群主
http_method: POST
http_path: /jim/groups/management/chgowner
path: /jim/groups/management/chgowner
method: POST
source: groups/groupsetting/chgowner.md
---
...
| --- | --- |
| HTTP 方法 | `POST` |
| 接口路径 | `/jim/groups/management/chgowner` |
...

{
  ...
  "args": {
    ...
    "path": "/jim/groups/management/chgowner",     // 后端 jim 接口路径
    "data": {"group_id": "groupid1", "owner_id": "userid2"}
  },
  "meta": { /* 可选附加元数据 */ }
}
```
...
- im-docs 源文件：`busserver/groups/groupsetting/chgowner.md`