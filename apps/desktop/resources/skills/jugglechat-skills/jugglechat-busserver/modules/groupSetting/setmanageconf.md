---
name: jugglechat-busserver.groupSetting.setmanageconf
module: groupSetting
action: setmanageconf
title: 设置群配置
http_method: POST
http_path: /jim/groups/management/set
path: /jim/groups/management/set
method: POST
source: groups/groupsetting/setgrpmanageconf.md
---
...
| --- | --- |
| HTTP 方法 | `POST` |
| 接口路径 | `/jim/groups/management/set` |
...

{
  ...
  "args": {
    ...
    "path": "/jim/groups/management/set",     // 后端 jim 接口路径
    "data": {"group_id": "groupid1", "group_edit_msg_right": 7, "group_add_member_right": 7, "group_mention_all_right": 7, "group_top_msg_right": 7, "group_send_msg_right": 7, "group_set_msg_life_right": 7}
  },
  "meta": { /* 可选附加元数据 */ }
}
```
...
- im-docs 源文件：`busserver/groups/groupsetting/setgrpmanageconf.md`