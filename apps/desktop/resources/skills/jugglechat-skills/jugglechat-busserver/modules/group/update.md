---
name: jugglechat-busserver.group.update
module: group
action: update
title: 更新群组信息
http_method: POST
http_path: /jim/groups/update
path: /jim/groups/update
method: POST
source: groups/groupmanage/updategroup.md
---
...

{
  ...
  "args": {
    ...
    "path": "/jim/groups/update",     // 后端 jim 接口路径
    "data": {"group_id": "groupid1", "group_name": "group1", "group_portrait": "https://aaaa.png"}
  },
  "meta": { /* 可选附加元数据 */ }
}
```
...
- im-docs 源文件：`busserver/groups/groupmanage/updategroup.md`