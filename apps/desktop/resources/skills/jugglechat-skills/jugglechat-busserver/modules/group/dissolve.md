---
name: jugglechat-busserver.group.dissolve
module: group
action: dissolve
title: 解散群组
http_method: POST
http_path: /jim/groups/dissolve
path: /jim/groups/dissolve
method: POST
source: groups/groupmanage/dissolvegroup.md
---
...

{
  ...
  "args": {
    ...
    "path": "/jim/groups/dissolve",     // 后端 jim 接口路径
...
- im-docs 源文件：`busserver/groups/groupmanage/dissolvegroup.md`