---
name: jugglechat-busserver.group.search
module: group
action: search
title: 搜索加入的群
http_method: POST
http_path: /jim/groups/mygroups/search
path: /jim/groups/mygroups/search
method: POST
source: groups/groupmanage/searchmygroups.md
---
...
| --- | --- |
| HTTP 方法 | `POST` |
| 接口路径 | `/jim/groups/mygroups/search` |
...

{
  ...
  "args": {
    ...
    "path": "/jim/groups/mygroups/search",     // 后端 jim 接口路径
    "data": {"keyword": "group", "limit": 100}
  },
  "meta": { /* 可选附加元数据 */ }
}
```
...
- im-docs 源文件：`busserver/groups/groupmanage/searchmygroups.md`