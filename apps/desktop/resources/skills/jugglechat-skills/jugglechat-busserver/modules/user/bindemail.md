---
name: jugglechat-busserver.user.bindemail
module: user
action: bindemail
title: 绑定邮箱
http_method: POST
http_path: /jim/users/bindemail
path: /jim/users/bindemail
method: POST
source: users/bindemail.md
---
...

{
  ...
  "args": {
    ...
    "path": "/jim/users/bindemail",     // 后端 jim 接口路径
    "data": {"email": "test@abc.com", "code": "123456"}
  },
  "meta": { /* 可选附加元数据 */ }
}
```
...
- im-docs 源文件：`busserver/users/bindemail.md`