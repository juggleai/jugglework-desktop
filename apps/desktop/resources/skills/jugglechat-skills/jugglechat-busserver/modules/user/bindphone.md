---
name: jugglechat-busserver.user.bindphone
module: user
action: bindphone
title: 绑定手机号
http_method: POST
http_path: /jim/users/bindphone
path: /jim/users/bindphone
method: POST
source: users/bindphone.md
---
...

{
  ...
  "args": {
    ...
    "path": "/jim/users/bindphone",     // 后端 jim 接口路径
...
- im-docs 源文件：`busserver/users/bindphone.md`