---
name: jugglechat-busserver.user.update
module: user
action: update
title: 更新用户信息
http_method: POST
http_path: /jim/users/update
path: /jim/users/update
method: POST
source: users/upduserinfo.md
---
...

{
  ...
  "args": {
    ...
    "path": "/jim/users/update",     // 后端 jim 接口路径
    "data": {"user_id": "userid1", "nickname": "user1", "avatar": "xxxxxx"}
  },
  "meta": { /* 可选附加元数据 */ }
}
```
...
- im-docs 源文件：`busserver/users/upduserinfo.md`