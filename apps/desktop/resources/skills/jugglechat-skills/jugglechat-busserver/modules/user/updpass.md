---
name: jugglechat-busserver.user.updpass
module: user
action: updpass
title: 更新密码
http_method: POST
http_path: /jim/users/updpass
path: /jim/users/updpass
method: POST
source: users/updpass.md
---
...

{
  ...
  "args": {
    ...
    "path": "/jim/users/updpass",     // 后端 jim 接口路径
    "data": {"user_id": "xxxxxxx", "password": "xxxxxx", "new_password": "xxxxx"}
  },
  "meta": { /* 可选附加元数据 */ }
}
```
...
- im-docs 源文件：`busserver/users/updpass.md`