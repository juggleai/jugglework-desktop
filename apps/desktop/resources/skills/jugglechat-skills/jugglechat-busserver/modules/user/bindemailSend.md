---
name: jugglechat-busserver.user.bindemailSend
module: user
action: bindemailSend
title: 绑定邮箱-发送邮件
http_method: POST
http_path: /jim/users/bindemail/send
path: /jim/users/bindemail/send
method: POST
source: users/bindemail_send.md
---
...

{
  ...
  "args": {
    ...
    "path": "/jim/users/bindemail/send",     // 后端 jim 接口路径
    "data": {"email": "test@abc.com"}
  },
  "meta": { /* 可选附加元数据 */ }
}
```
...
- im-docs 源文件：`busserver/users/bindemail_send.md`