---
name: jugglechat-busserver.friend.search
module: friend
action: search
title: 好友搜索
http_method: POST
http_path: /jim/friends/search
path: /jim/friends/search
method: POST
source: friends/friendsearch.md
---
...

{
  ...
  "args": {
    ...
    "path": "/jim/friends/search",     // 后端 jim 接口路径
    "data": {"key": "user"}
  },
  "meta": { /* 可选附加元数据 */ }
}
...
- im-docs 源文件：`busserver/friends/friendsearch.md`