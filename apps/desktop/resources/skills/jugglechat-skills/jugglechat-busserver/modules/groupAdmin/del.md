---
name: jugglechat-busserver.groupAdmin.del
module: groupAdmin
action: del
title: 移除管理员
http_method: POST
http_path: /jim/groups/management/administrators/del
path: /jim/groups/management/administrators/del
method: POST
source: groups/groupadmins/deladmin.md
---
...
| --- | --- |
| HTTP 方法 | `POST` |
| 接口路径 | `/jim/groups/management/administrators/del` |
...

{
  ...
  "args": {
    ...
    "path": "/jim/groups/management/administrators/del",     // 后端 jim 接口路径
    "data": {"group_id": "group1", "admin_ids": ["userid1", "userid2"]}
  },
  "meta": { /* 可选附加元数据 */ }
}
```
...
- im-docs 源文件：`busserver/groups/groupadmins/deladmin.md`