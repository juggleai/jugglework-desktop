---
name: jugglechat-busserver.assistant.update
module: assistant
action: update
title: 更新提示词
http_method: POST
http_path: /jim/assistants/prompts/update
path: /jim/assistants/prompts/update
method: POST
source: assistants/promptupdate.md
---
...
| --- | --- |
| HTTP 方法 | `POST` |
| 接口路径 | `/jim/assistants/prompts/update` |
...

{
  ...
  "args": {
    ...
    "path": "/jim/assistants/prompts/update",     // 后端 jim 接口路径
    "data": {"id": "xxx", "prompts": "xxxxxxxxxxxx"}
  },
  "meta": { /* 可选附加元数据 */ }
}
```
...
- im-docs 源文件：`busserver/assistants/promptupdate.md`