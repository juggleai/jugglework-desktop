---
name: jugglechat-busserver.assistant.del
module: assistant
action: del
title: 删除提示词
http_method: POST
http_path: /jim/assistants/prompts/del
path: /jim/assistants/prompts/del
method: POST
source: assistants/promptdel.md
---
...
| --- | --- |
| HTTP 方法 | `POST` |
| 接口路径 | `/jim/assistants/prompts/del` |
...

{
  ...
  "args": {
    ...
    "path": "/jim/assistants/prompts/del",     // 后端 jim 接口路径
    "data": {"id": "xxx"}
  },
  "meta": { /* 可选附加元数据 */ }
}
...
- im-docs 源文件：`busserver/assistants/promptdel.md`