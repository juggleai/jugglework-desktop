---
name: jugglechat-busserver.assistant.batchdel
module: assistant
action: batchdel
title: 批量删除提示词
http_method: POST
http_path: /jim/assistants/prompts/batchdel
path: /jim/assistants/prompts/batchdel
method: POST
source: assistants/promptbatchdel.md
---
...
| --- | --- |
| HTTP 方法 | `POST` |
| 接口路径 | `/jim/assistants/prompts/batchdel` |
...

{
  ...
  "args": {
    ...
    "path": "/jim/assistants/prompts/batchdel",     // 后端 jim 接口路径
    "data": {"ids": ["xxx", "yyy"]}
  },
  "meta": { /* 可选附加元数据 */ }
}
...
- im-docs 源文件：`busserver/assistants/promptbatchdel.md`