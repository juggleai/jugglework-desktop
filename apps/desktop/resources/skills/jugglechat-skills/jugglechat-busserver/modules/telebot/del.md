---
name: jugglechat-busserver.telebot.del
module: telebot
action: del
title: 移除Bot
http_method: POST
http_path: /jim/telegrambots/batchdel
path: /jim/telegrambots/batchdel
method: POST
source: telebots/botdel.md
---
...
| --- | --- |
| HTTP 方法 | `POST` |
| 接口路径 | `/jim/telegrambots/batchdel` |
...

{
  ...
  "args": {
    ...
    "path": "/jim/telegrambots/batchdel",     // 后端 jim 接口路径
    "data": {"bot_ids": ["id1", "id2"]}
  },
  "meta": { /* 可选附加元数据 */ }
}
```
...
| 参数 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| `bot_ids` | — | — | （im-docs 源文档未提供说明，下方请求示例可参考） |
...
- im-docs 源文件：`busserver/telebots/botdel.md`