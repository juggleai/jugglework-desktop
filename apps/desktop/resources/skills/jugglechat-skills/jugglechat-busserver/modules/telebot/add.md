---
name: jugglechat-busserver.telebot.add
module: telebot
action: add
title: 添加Bot
http_method: POST
http_path: /jim/telegrambots/add
path: /jim/telegrambots/add
method: POST
source: telebots/botadd.md
---
...

{
  ...
  "args": {
    ...
    "path": "/jim/telegrambots/add",     // 后端 jim 接口路径
    "data": {"bot_name": "xxxxxxxxxxxx", "bot_token": "xxxx"}
  },
  "meta": { /* 可选附加元数据 */ }
}
```
...
| 参数 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| `bot_name` | — | — | （im-docs 源文档未提供说明，下方请求示例可参考） |
| `bot_token` | — | — | （im-docs 源文档未提供说明，下方请求示例可参考） |
...
- im-docs 源文件：`busserver/telebots/botadd.md`