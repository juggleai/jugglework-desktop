---
name: jugglechat-im-sdk.message.removeFavoriteMessages
module: message
action: removeFavoriteMessages
title: 移除收藏
source: message/favorite/remove.md
---
...
```js
jim.removeFavoriteMessages(args)
```
...
- im-docs 源文件：`message/favorite/remove.md`