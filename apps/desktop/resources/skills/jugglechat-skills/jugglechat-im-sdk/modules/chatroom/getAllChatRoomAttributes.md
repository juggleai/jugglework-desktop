---
name: jugglechat-im-sdk.chatroom.getAllChatRoomAttributes
module: chatroom
action: getAllChatRoomAttributes
title: 获取全部属性
source: chatroom/get_all_kvs.md
---
...
```js
jim.getAllChatRoomAttributes(args)
```
...
- im-docs 源文件：`chatroom/get_all_kvs.md`