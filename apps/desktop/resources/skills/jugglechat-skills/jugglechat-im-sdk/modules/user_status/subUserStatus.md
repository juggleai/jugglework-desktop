---
name: jugglechat-im-sdk.user_status.subUserStatus
module: user_status
action: subUserStatus
title: 订阅状态
source: user_status/sub.md
---
...
- im-docs 源文件：`user_status/sub.md`