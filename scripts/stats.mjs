...
const POSTHOG_DISTINCT_ID = process.env.POSTHOG_DISTINCT_ID || "jugglework-download"
const GITHUB_REPO = process.env.GITHUB_REPO || "juggleai/jugglework-desktop"
...
async function fetchReleases() {
  ...
  const headers = {
    ...
    "User-Agent": "jugglework-download-stats",
  }
