---
title: "JuggleWork MCP for Claude Code"
sidebarTitle: "Claude Code"
description: "Claude Code MCP setup for JuggleWork Connect, with OAuth access to your org's Gmail, Calendar, Drive, shared MCP connections, skills, and Cloud resources."
---

The JuggleWork MCP server ([JuggleWork Connect](/cloud/run-in-the-cloud/cloud-mcp))
enables Claude Code to use the JuggleWork capabilities your organization has made
...
1. Add JuggleWork Connect as a remote HTTP MCP server:

   ```sh
   claude mcp add --transport http jugglework https://work.juggle.im/jwork/api/mcp/agent
   ```
...
3. Select `jugglework`, then follow the browser sign-in and choose your
   organization.

## Switch organizations

Run `/mcp` inside Claude Code, select `jugglework`, then clear or
