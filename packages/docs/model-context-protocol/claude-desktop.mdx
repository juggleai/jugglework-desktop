---
title: "JuggleWork MCP for Claude Desktop"
sidebarTitle: "Claude Desktop"
description: "Claude Desktop MCP setup for JuggleWork Connect, using custom connectors or mcp-remote to reach your org's shared capabilities."
---

The JuggleWork MCP server ([JuggleWork Connect](/cloud/run-in-the-cloud/cloud-mcp))
enables Claude Desktop to use the JuggleWork capabilities your organization has
...
3. Name it `JuggleWork` and set the URL to:
...
JuggleWork accepts. Restart Claude Desktop after editing the config.
