...
Most people should start with the [JuggleWork app](https://openworklabs.com/download). It lets you use any LLM, skill, and plugin locally, then share that setup with your team when you are ready.
...
<CardGroup cols={3}>
  <Card title="Download JuggleWork" icon="download" href="https://openworklabs.com/download">
