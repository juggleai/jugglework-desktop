...
description: "Learn how to save skills to JuggleWork Cloud for your teammates"
---

JuggleWork sharing focuses on saving skills to your JuggleWork Cloud organization so teammates can install them from the Cloud tab.

## How to save a skill to your JuggleWork Cloud organization
...
3. Sign in to JuggleWork Cloud if needed.
