...
description: "Create an org on JuggleWork Cloud, invite teammates into teams, publish a plugin with a skill to a marketplace, and trigger it from the desktop app"
---

Set up a team on [work.juggle.im](https://work.juggle.im), publish your first skill, and trigger it from the desktop app — in about 15 minutes.

By the end of this walkthrough you will have:

1. Created an organization on JuggleWork Cloud.
...
5. Signed in to the org from the JuggleWork desktop app and triggered the skill with a plain-language prompt.

<Note>
**Seats:** every workspace includes **5 free seats**. If you need more seats, SSO, or early access to analytics, [reach out](mailto:founders@juggle.im).
</Note>
...
Head to [work.juggle.im](https://work.juggle.im). Enter your work email and press **Next** — JuggleWork routes you to the right sign-in step automatically.

<Frame>
  ![Start using JuggleWork — email step](/images/cloud-team-quickstart/01-signin-email.png)
</Frame>
...
Right after sign-up, JuggleWork asks you to **name your team**. This creates your organization — you can rename it later, and no credit card is required.
...
Open **Extensions → Plugins**. You'll see JuggleWork's built-in plugins; click **Create plugin** to add your own.
...
In the **Share** section, keep *Share with everyone in the organization* checked and pick your **Marketplace** — this is what publishes the plugin so members find it in the JuggleWork app. Click **Create plugin**.
...
Changing workspace access is sensitive, so JuggleWork asks you to confirm your password first:
...
Now switch to the [JuggleWork desktop app](https://juggle.im). On the welcome screen, click **Joining a team? Sign in** and sign in with the same account.

<Frame>
  ![Desktop welcome](/images/cloud-team-quickstart/18-desktop-welcome.png)
</Frame>

JuggleWork restores the organization you used last. On first sign-in it opens
your personal organization; use the account menu to switch to the team
organization you just configured.

JuggleWork shows what your org gives you access to — including your marketplaces:
...
<Note>
**Need more?** The first 5 users in your organization are free; additional users are $10 per user per month. For SSO or early analytics access, [contact us](mailto:founders@juggle.im).
</Note>
