...
Head to [app.openworklabs.com](https://app.openworklabs.com). Enter your work email and press **Next** — JuggleWork routes you to the right sign-in step automatically.
...
Now switch to the [JuggleWork desktop app](https://openworklabs.com). On the welcome screen, click **Joining a team? Sign in** and sign in with the same account.
