...
JuggleWork Cloud requires an active subscription at [app.openworklabs.com](https://app.openworklabs.com/).
...
4. If the browser does not return to JuggleWork automatically, click `Paste sign-in code`, paste the `openwork://den-auth?...` link or one-time code from JuggleWork Cloud, then click `Finish sign-in`.
