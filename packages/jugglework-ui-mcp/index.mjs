...
const DISCOVERY_FILE = "jugglework-ui-control.json";
...
function discoveryPaths() {
  return [
    ...
    join(userAppDataDir(), "com.juggleai.jugglework", DISCOVERY_FILE),
    join(userAppDataDir(), "com.juggleai.jugglework.dev", DISCOVERY_FILE),
  ].filter(Boolean);
}
...
// ── jugglework://context/current ──
server.resource(
  "current_jugglework_context",
  "jugglework://context/current",
  async (uri) => {
