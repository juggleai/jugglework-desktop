...
const HELPER_APP = process.env.JUGGLEWORK_COMPUTER_USE_HELPER
  ?? join(repoRoot, "apps/desktop/resources/helpers/JuggleWork Computer Use.app");
...
try { execSync(`pkill -f 'JuggleWork Computer Use.app'`); } catch {}
