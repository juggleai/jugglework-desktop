...
3. Search highlighting still marks matching text inside rendered Markdown without changing the underlying message content.

4. Markdown displayed outside the chat, including artifact or extension detail content, uses the same safe formatting rules and remains readable.
