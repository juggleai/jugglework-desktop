...
1. I run `pnpm demo:electron`, and two JuggleWork demo windows launch together.

2. Each window uses its own newly created temporary folder, completely separate from the production JuggleWork data directory.
