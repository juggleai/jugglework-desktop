...
1. A Windows teammate launches JuggleWork and the stock icon is visible in the real taskbar.
...
4. After closing and relaunching JuggleWork, the branded icon appears from the first visible window.

5. Clearing the organization icon restores the stock JuggleWork icon.
