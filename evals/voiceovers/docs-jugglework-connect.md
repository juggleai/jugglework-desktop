# docs-jugglework-connect — use the same JuggleWork Connect installer from the docs or landing page

1. I open the JuggleWork Connect docs and immediately see the same installer available on the landing page.

2. I select OpenCode and get the exact remote MCP configuration using `https://work.juggle.im/jwork/api/mcp/agent`.
