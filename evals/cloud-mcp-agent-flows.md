...
End-to-end flows where the **agent itself** (composer prompts) operates JuggleWork
Cloud through the `jugglework-cloud` MCP. These validate the real product story:
...
3. Open Settings -> Extensions -> MCP and wait for **JuggleWork Cloud Control —
...
4. A working model provider must be configured (flows below ran on
   `jugglework/kimi-k2.6`).

## Flow 1: Which cloud am I connected to

**Prompt:** "Which JuggleWork Cloud organization am I connected to? Use your
jugglework-cloud tools to check."
...
**Prompt:** "Add omar@juggle.im to my organization as a member using
your jugglework-cloud tools."
...
**Prompt:** "Assign <member> to the Sales team using your jugglework-cloud tools."
...
organization using the proper JuggleWork Cloud way: create a plugin containing
...
`weekly-report` in JuggleWork Marketplace.
