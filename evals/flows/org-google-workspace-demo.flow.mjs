 ...
 * - Frame 5: a real chat turn creates a Gmail draft through JuggleWork Cloud
...
const WORKSPACE_PATH = `/tmp/jugglework-org-google-workspace-${RUN_TAG}`;
