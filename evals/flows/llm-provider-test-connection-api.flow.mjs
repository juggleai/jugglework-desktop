 ...
 *
 * Required env:
 * - JUGGLEWORK_EVAL_DEN_WEB_URL   Den web origin (e.g. http://localhost:3015)
 * - JUGGLEWORK_EVAL_DEN_EMAIL     Seeded user email (sign-in fallback)
 * - JUGGLEWORK_EVAL_DEN_PASSWORD  Seeded user password (sign-in fallback)
 */
...
export default {
  ...
  requiredEnv: ["JUGGLEWORK_EVAL_DEN_WEB_URL", "JUGGLEWORK_EVAL_DEN_EMAIL", "JUGGLEWORK_EVAL_DEN_PASSWORD"],
  steps: [
    {
