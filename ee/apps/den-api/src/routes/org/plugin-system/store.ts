...
const DEFAULT_OPENWORK_EXTENSION_MANIFESTS = [
  {
    ...
    setup: { instructions: "JuggleWork Browser is ready by default in desktop workspaces." },
  ...
  },
  {
    ...
    setup: { instructions: "Add an OpenAI API key, then agents can generate image artifacts through JuggleWork extension actions." },
    resources: [
  ...
  },
  {
    ...
    setup: { instructions: "Connect your Google account to use Calendar, Drive, and Gmail drafts in JuggleWork." },
    resources: [
...
function serializePluginExtension(row: PluginRow, componentCounts: Record<string, number>) {
  ...
  return {
    ...
    manifest: {
      ...
      setup: {
        instructions: "Imported from a Claude-compatible plugin. JuggleWork installs its resources into this workspace as extension components.",
      },
      lifecycle: {
